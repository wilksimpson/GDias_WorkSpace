////////////////////////////////////////////////////////////////////////////////////////////////
// Relatorio GTR005 - Mostra os pedidos de compra com suas alocações nos centros de custo.    //
//                    Por indice por Centro de Custo                                          //
// Criado em 06-01-2009 por Luiz Jorge                                                        //
...
Local cPict          := ""
Local titulo         := "Relação de Compras x Centro de Custo (Por Ordem de Centro de Custo)"
Local nLin           := 80
...
Private limite       := 132
Private tamanho      := "M"
Private nomeprog     := "GTR005" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 18
Private aReturn      := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey     := 0
Private cPerg        := "GTR005"
Private cbtxt        := Space(10)
Private cbcont       := 00
Private CONTFL       := 01
Private m_pag        := 01
Private wnrel        := "GTR005" // Coloque aqui o nome do arquivo usado para impressao em disco
Private cString      := "SC7"
...
_cQry += " ORDER BY SD1.D1_CC, SD1.D1_EMISSAO"
